...
response SHALL contain only customer ID, canonical phone, and saved billing
name. No outlet role or device SHALL have a browse, prefix, fuzzy, aggregate,
or direct-table read path.
