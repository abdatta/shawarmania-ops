...
Guarantees that estimated profit is always reported on one of two named bases, always stated on screen, and never double-counts raw materials: cash basis subtracts everything spent, consumption basis subtracts running costs and the stock actually used. Integer paise throughout.
