...
- [x] 6.5 Share the order and bill presentation between integrated and dedicated surfaces, preserve the narrower routes, and reshape the counter shimmer to reserve the three-column layout.
