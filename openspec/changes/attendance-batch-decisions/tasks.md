...
- [ ] 10.1 Run `npm run lint`, `npm run format:check`, `npm run typecheck`, `npm test`, `npm run test:db`, `npm run test:rls`, `npm run contrast`, `npm run build`, and `npm run test:e2e` in both themes at phone and tablet widths, plus `npm run test:e2e:auth`.
