...
| 📝 | 38 | D | `the-ledger-opens-to-the-outlet` | **Opus** | proposed | #22, #36, #37 | a Biller records a cash expense at their own outlet from their own phone and is refused yesterday's by the database; a Franchise Admin reads the full day and month at outlets they are assigned to and no others; a staff member is refused a past day's revenue, a month's aggregate and any alteration of a day's counted cash by the database, not by a hidden screen; and a voided expense stays visible, struck through, and stops counting |
