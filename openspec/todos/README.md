...
| [The Demo Month Reads As A Loss](./the-demo-month-reads-as-a-loss.md) | Fixture gap | Open | Demo mode / Reporting | **#13 `owner-console-live`**, where the P&L stops being demo data. The demo's expenses cover a notebook month while its bills cover a few days, which the withdrawn consumption basis used to hide |
