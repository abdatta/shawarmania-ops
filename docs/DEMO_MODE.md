...
**Narrow the window** until three columns no longer fit. Nothing rearranges and nothing becomes a tab—the workspace scrolls sideways, each column about a phone's width. That is why there is no Open orders, My shift or Menu entry in this shell: all three are columns that never leave the screen.
